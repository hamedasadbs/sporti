...
const Footer=()=>(
    <>
        <footer className={classes.footer}>
            <h2 className={classes.title}>فانتزیما، اولین فروشگاه جامع اینترنتی ادبیات ، بازی های کامپیوتری و سینمای فانتزی در ایران</h2>
            <main>
                ...
                <div className={classes.rightSide}>
                    <table className={classes.subjects}>
                        <tbody>
                            <tr>
                                <td><a>فرآیند خرید</a></td>
                            </tr>
                            <tr>
                                <td><a>پرسش های متداول</a></td>
                            </tr>
                            <tr>
                                <td><a>شرایط بازگرداندن کالا</a></td>
                            </tr>
                            <tr>
                                <td><a>حریم خصوصی</a></td>
                            </tr>
                            <tr>
                                <td><a>فرم پیشنهاد محصول</a></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
